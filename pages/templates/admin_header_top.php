...
.alert-page-panel { border-radius:0px;margin-bottom:0px;margin-left:-3%;margin-right:-3%; }
.modal-header-blue { background-color:#2196f3;color:#fff; }
.btn-mediumPurple,.btn-mediumPurple:hover,.btn-mediumPurple:focus,.btn-mediumPurple:active { background-color:#9c27b0;border:1px solid #9c27b0;color:#fff; }
